...
public class EjemploParamsController {
	...
	//required es una forma de controlar la excepcion que se generaria por no enviar el valor
	//default tambien se puede usar para mandar un valor por defecto en caso no reciba parametro
	@GetMapping("/string")
